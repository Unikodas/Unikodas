  ...
  return (
    <>
      ...
      <ol className="list-decimal space-y-3 pl-6">
        ...
        <li>Aukcionuose gali dalyvauti tik SMS patvirtinę, el. paštą patvirtinę ir pranešimus įjungę vartotojai. Prisijungdamas prie aukciono vartotojas sutinka, kad administracija matytų jo kontaktus, susisiektų telefonu arba el. paštu dėl ketinimo dalyvauti, patikrintų tapatybę ir koordinuotų galimą sandorį.</li>
